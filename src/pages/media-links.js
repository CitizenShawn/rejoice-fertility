      ...
      <section sx={{ p: { fontSize: ['1rem', null, '1.25rem'], mb: '1rem' } }}>
        <div sx={{ maxWidth: '1400px', mx: 'auto', p: '2rem' }}>
          ...
          <div sx={{ h3: { mb: '12px', fontSize: ['1.25rem', null, '2rem'], fontWeight: '700' }, h4: { fontSize: ['1.25rem', null, '1.5rem'] }, color: '#000', p: { mb: '1rem' } }}>
            ...
            <Header title={'A Record-Breaking Baby Has Been Born'} image={'/images/record-breaking.png'} description={'Article by MIT Technology Review, Video by Sky News'} ctaPrimary={'Read the Article Here'} ctaPrimaryLink={'https://www.technologyreview.com/2025/07/29/1120769/exclusive-record-breaking-baby-born-embryo-over-30-years-old/'} ctaSecondary={'Watch the Video'} ctaSecondaryLink={'https://news.sky.com/video/worlds-oldest-baby-born-from-embryo-frozen-30-years-ago-13404768'} />
