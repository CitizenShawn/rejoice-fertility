...
const NightlightPage = () => {
  ...
  return (
    <Layout>
      ...
      />
      <Header title={'Christian Adoption Consultants'} description={''} image={'/images/CAC-cropped.jpg'} ctaPrimary={'Learn More'} ctaPrimaryLink={'https://www.christianadoptionconsultants.com'} ctaSecondary={'Specialty Pricing'} ctaSecondaryLink={'/Rejoice-Fee-Schedule-CAC.pdf'} />
      <section
        sx={{
          display: 'flex',
