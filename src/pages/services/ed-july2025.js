...
const EmbryoDonationPage = () => {
  ...
  return (
    <Layout>
      ...
      />
      <Header title={'Embryo Adoption'} image={'/images/embryo-adoption-crop.jpg'} ctaPrimary={'Adopt Embryos'} ctaPrimaryLink={'/services/embryo-adoption'}/>
      <section
        sx={{
          display: 'flex',
      ...
      <Header title={'DONATE NOW'} image={'/images/embryos-child-1.jpg'} description={'If you have embryos that you wish to donate to another couple, then we would love to help you give the gift of life. Patients who wish to donate their IVF frozen embryos through either Open or Closed Embryo Adoption now have another option. Rejoice Embryo Rescue and its 3 affiliated faithbased Embryo Adoption Services are ready to help you through this difficult decision and process of placing your embryos with another family. Adoption counselors will work to place your embryos in families looking to adopt and you can determine your level of contact with the adopting family.'}/>
      <Header title={'Embryo Adoption'} image={'/images/embryo-adoption-crop.jpg'} ctaPrimary={'Adopt Embryos'} ctaPrimaryLink={'/services/embryo-adoption'}/>
      <Header title={'Embryo Adoption'} image={'/images/embryo-adoption-crop.jpg'} ctaPrimary={'Adopt Embryos'} ctaPrimaryLink={'/services/embryo-adoption'}/>
      <Faqs data={data} />
      <section
