...
const EmbryoDonationPage = () => {
  ...
  const q = [
    ...
    },
    {
      ...
      answer:
        "Rejoice Embryo Rescue, LLC will coordinate the shipping of your embryos to Rejoice IVF Lab, LLC using Cryoport, a trusted partner that most IVF clinics to use to ship embryos. Until they are adopted your embryos will be stored at Rejoice IVF Lab, LLC a The Joint Commission accredited IVF laboratory. You will not be billed for the shipping or storage of your embryos unless at some point you change your mind after your embryos have arrived in Knoxville. \nRejoice IVF Lab, LLC has robust protocols so that when embryos are shipped in we verify each and every device upon arrival to our facility, ensuring that the number arriving is accurately tracked \nin our inventory. We have a dual tank monitoring systems that provide 24/7 continuous monitoring (industry standard is only one monitoring system). Our monitoring systems monitor the temperature inside the tanks and send alerts via cell signal if the temperature falls below the threshold. Our thermal video surveillance monitoring system (Cryosentinel) checks the outside of the storage tanks for early indication of a vacuum seal breach and this system allows us to remotely verify the status and integrity of all tanks before a problem arises. \nAll alarms will call out to the personal cell phones of all five of our embryology lab staff, ensuring we have 365 days/24 hours a day coverage with an on-site staff member to respond to any emergency. In addition, the levels of liquid nitrogen in our tanks are measured by one of our embryologists (as opposed to relying on electronic means that could fail) 3x per week. Tanks are maintained by our staff and the liquid nitrogen is replenished on a regularly scheduled basis.",
    },
    {
      question: 'Step 3: Matching of your embryos with an adopting family',
      answer: 'Once your embryos have arrived at Rejoice IVF Lab, they will be entered into our donor database which can be searched by the faith-based adoption agencies with whom we are affiliated. At present these include: \n\nSnowflakes (Nightlife Christian Adoptions)  \n\nEmbryo Adoption Services of Cedar Park  \nFlourish Adoption Ministries  \n\nIf you are more comfortable with a closed Embryo Adoption, then at this point your job is done once you have completed and signed all of the necessary forms. and we thank you for making the difficult but life-affirming decision to place your embryos up for adoption. \nIf you have elected to pursue Open or Semi-open Embryo Adoption, then once a potential recipient match is found, the adoption agency (one of the 3 listed above) will reach out to you for approval. The agency will handle the legal contracts specifying the degree of contact between you and the recipient family. \nOnce adopted, your embryos may remain at Rejoice IVF Lab if the adopting couple has elected to have their frozen embryo transfer performed here in Knoxville at Rejoice Fertility, or if the adopting couple elects (and you agree at the time of your donation), the embryos may be shipped to any accredited IVF laboratory by Rejoice IVF Lab using Cryoport. ',
    },
    {
